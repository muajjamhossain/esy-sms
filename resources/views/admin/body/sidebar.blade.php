    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/setups')?'active':'' }}">
                <a href="#">
                    <i data-feather="credit-card"></i> <span>Academic Setup</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-right pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('fee.amount.view') }}"><i class="ti-more"></i>Fee Category Wise Amount</a></li>
                    ...
                    <li><a href="{{ route('routine.index') }}"><i class="ti-more"></i>Class Routine</a></li>
            ...
            <li class="treeview {{ ($prefix == '/students')?'active':'' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('student.attendance.view') }}"><i class="ti-more"></i>Student Attendance</a>
                    </li>
            ...
            <li class="treeview {{ ($prefix == '/reports')?'active':'' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'employee.attendance.report.view')?'active':'' }}"><a
                            href="{{ route('employee.attendance.report.view') }}"><i class="ti-more"></i>Employee Attendance Report</a>
                    </li>

                    <li class="{{ ($route == 'student.attendance.report.view')?'active':'' }}"><a
                            href="{{ route('student.attendance.report.view') }}"><i class="ti-more"></i>Student Attendance Report</a>
                    </li>
