...
Route::group(['middleware' => 'prevent-back-history'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::prefix('students')->group(function () {
            ...
            Route::get('attendance/students/view', [StudentAttendanceController::class, 'AttendanceView'])->name('student.attendance.view');

            Route::get('attendance/students/add', [StudentAttendanceController::class, 'AttendanceAdd'])->name('student.attendance.add');

            Route::post('attendance/students/store', [StudentAttendanceController::class, 'AttendanceStore'])->name('store.student.attendance');
            Route::post('attendance/students/search', [StudentAttendanceController::class, 'StudentClassYearWise'])->name('search.student.attendance');

            Route::get('attendance/students/edit/{date}', [StudentAttendanceController::class, 'AttendanceEdit'])->name('student.attendance.edit');

            Route::get('attendance/students/details/{date}', [StudentAttendanceController::class, 'AttendanceDetails'])->name('student.attendance.details');
        });
